...
@software: pycharm
@file: Sentiment_CNN.py
@time: 2021/12/3 3:39 PM
@desc: CNN MODEL FOR SENTIMENT
"""

import torch
import torch.nn as nn
import torch.nn.functional as F
from RENlp_Sentiment.models import BasicModule, Embedding


class Sentiment_CNN(BasicModule):
    def __init__(self, vocab_size, config):
        super(Sentiment_CNN, self).__init__()
        self.model_name = 'Sentiment_CNN'
    ...
    def forward(self, input):
        ...
        x = torch.transpose(x, 1, 2)  # [128,320,124]
