# -*- coding = utf-8 -*-
# @Time :2021/11/25 8:47
# @Author:ren.jieye
# @Describe:
# @File : data_prcessor.py
# @Software: PyCharm IT
import os

from RENlp_NER.utils import *
...
class NerProcessor(DataProcessor):
    ...
    def get_examples(self, data_dir, type):
        return self._create_examples(
            self._read_tsv(os.path.join(data_dir, type+".txt")), type
        )
    ...
    def get_labels(self, args):
        """
                ...
                :return:
                """
        label_pkl_path = os.path.join(args.output_dir, "label_list.pkl")
        if os.path.exists(label_pkl_path):
            ...
            tokens_list = load_file(args.train_file, sep=args.sep)
